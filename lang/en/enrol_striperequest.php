...
/**
 * Strings for component 'enrol_striperequest', language 'en'.
 *
...
$string['pluginname'] = 'INDES Stripe Request';
...
$string['messageprovider:striperequest_enrolment'] = 'Message Provider';

$string['maxenrolled'] = 'Max enrolled users';
$string['maxenrolled_help'] = 'Specifies the maximum number of users that can striperequest enrol. 0 means no limit.';
$string['maxenrolledreached'] = 'Maximum number of users allowed to striperequest-enrol was already reached.';

$string['canntenrol'] = 'Enrolment is disabled or inactive';
$string['striperequest:config'] = 'Configure striperequest';
$string['striperequest:manage'] = 'Manage striperequest';
$string['striperequest:unenrol'] = 'Unenrol striperequest';
$string['striperequest:unenrolself'] = 'Unenrolself striperequest';
