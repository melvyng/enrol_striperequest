...
$(document).ready(function() {
    $("#apply").click(function() {
        var txt = $("#coupon").val();
    $.post("<?php echo $CFG->wwwroot; ?>/enrol/striperequest/validate-coupon.php",
    {coupon_id: txt, courseid: '<?php echo $course->id; ?>'}, function(data, status) {

       if(data == 'wrong') {
         $("#coupon").focus();
         $("#new_coupon").html('<p style="color:red;"><b><?php echo get_string("invalidcouponcode", "enrol_striperequest"); ?>
         </b></p>');
       } else {
...
<img src="<?php echo $CFG->wwwroot; ?>/enrol/striperequest/stripe.png"></div>
<p><?php print_string("paymentrequired") ?></p>
<!-- <p><b><?php echo $instancename; ?></b></p> //-->
<p><b><?php echo get_string("cost").": {$instance->currency} {$cost}"; ?></b></p>
<div class="couponcode-wrap">
<span class="couponcode-text"> <?php echo get_string("couponcode", "enrol_striperequest"); ?>: </span>
<input type=text id="coupon"/>
<button id="apply"><?php echo get_string("applycode", "enrol_striperequest"); ?></button>
</div>
    ...
    cardButton.addEventListener('click', function(event) {
      ...
      if (status == 0 || status == null) {
         ...
         $.ajax({
          ...
          url: "<?php echo $CFG->wwwroot; ?>/enrol/striperequest/paymentintendsca.php",
          method: 'POST',
          data: {
...
<form id="stripeform" action="<?php echo "$CFG->wwwroot/enrol/striperequest/charge.php"?>" method="post">
...
echo "$CFG->wwwroot/enrol/striperequest/free_enrol.php"?>" method="post">
