...
$instance = $DB->get_record('enrol', array('id' => $enrolid, 'enrol' => 'striperequest'), '*', MUST_EXIST);
...
$PAGE->set_url('/enrol/striperequest/unenrolself.php', array('enrolid' => $instance->id));
...
$message = get_string('unenrolselfconfirm', 'enrol_striperequest', format_string($course->fullname));
